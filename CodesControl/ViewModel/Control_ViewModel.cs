...
namespace CodesControl.ViewModel
{
    public class Control_ViewModel
    {
        ...
        public ObservableCollection<ViewModel.ItemUserCodes_ViewModel> ItemsArray { get; set; }

        public Control_ViewModel()
        {
            ItemsArray = new ObservableCollection<ViewModel.ItemUserCodes_ViewModel>();
        ...
        public ObservableCollection<ItemUserCodes_ViewModel> AviableCollection
        {
            get
            {
